...
Special thanks to [Maxim Dounin][4] for his long-standing work on nginx and for creating and maintaining freenginx.

This container image is maintained independently by [honeok][5] and is not affiliated with, endorsed by, sponsored by, or supported by [F5, Inc][6]. or the F5-maintained NGINX project.

NGINX is a registered trademark of [F5, Inc][6]. The names nginx and NGINX are used here only to describe software compatibility, historical origin, and upstream relationship.
